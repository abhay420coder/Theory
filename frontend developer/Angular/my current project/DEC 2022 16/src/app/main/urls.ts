...
export const globalUrls = {
    ...
    rtDeploymentHasLockUnlockCreateUpdate: environment.baseUrl + '/rt-deployment-has-lock-unlock/create-update',
    rtDeploymentHasLockUnlockList: environment.baseUrl + "/rt-deployment-has-lock-unlock/list",
    // Namespace URLs
